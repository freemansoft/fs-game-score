...
- We may collect non-personal, aggregated, or de-identified data, such as:
  - Device type
  - Operating system
  - App version
- This information is used solely for the purpose of improving the app's functionality, performance, and stability.
- It is not used for advertising, tracking, or any other purpose that could identify you.

## Security

- Since no personal data is collected, there are no security measures in place to protect personal information.

## Changes to This Policy

- We may update this privacy policy from time to time.
- The "Last Updated" date at the top will be changed whenever we make any modifications.
- We will notify users of any changes by updating the policy within the application.
